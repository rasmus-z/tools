...
private:
    ...
    static std::wstring        GetShellItemDisplayName(IShellFolder* shellFolder, LPITEMIDLIST pidl);
    static std::wstring        GetShellItemFullyQualifiedName(IShellFolder* shellFolder, LPITEMIDLIST pidl);
    static std::wstring        GetShellItemPath(IShellFolder* shellFolder, LPITEMIDLIST folderpidl, LPITEMIDLIST pidl);
    bool                       InclusiveSort();
    bool                       GetShellItemFileTime(IShellFolder* shellFolder, LPITEMIDLIST folderpidl, LPITEMIDLIST pidl, FILETIME* fileTime);
};
